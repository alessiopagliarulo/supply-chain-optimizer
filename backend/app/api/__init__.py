...
from app.api import auth, catalogue, components, distributors, cart, live_prices, ml, graph, feeds, benchmark, resilience, demand, newsvendor, routing, routing_places
...
__all__ = ["api_router"]
api_router.include_router(routing_places.router)
