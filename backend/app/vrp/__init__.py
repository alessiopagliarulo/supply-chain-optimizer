...
def solve(instance: VrpInstance, method: str = "auto", time_limit_seconds: float = 5.0, seed: int = 42) -> VrpSolution:
    ...
    if method == "cpsat":
        return solve_cpsat(instance, time_limit_seconds=time_limit_seconds, seed=seed)
